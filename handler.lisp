...
(defmethod install-handler ((parent dispatching-handler) child
  ...
  "Install CHILD as a sub-handler of PARENT.  DISCRIMINATOR should be a portion of request urlstring that the sub-handler should be selected for.  EXACT-P controls whether CHILD will be selected only for requests that exactly match DISCRIMINATOR or for all requests prefixed with DISCRIMINATOR.  Bugs: this docstring is completely incomprehensible"
